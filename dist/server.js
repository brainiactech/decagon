...
const country_route_1 = (0, tslib_1.__importDefault)(require("./routes/country.route"));
const validateEnv_1 = (0, tslib_1.__importDefault)(require("./utils/validateEnv"));
(0, validateEnv_1.default)();
const app = new app_1.default([new index_route_1.default(), new auth_route_1.default(), new country_route_1.default()]);
app.listen();
